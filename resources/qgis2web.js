...
var map = new ol.Map({
    ...
    layers: layersList,
    view: new ol.View({
        extent: [-8209246.374133, 1190118.485041, -8031831.024172, 1316979.609193], maxZoom: 28, minZoom: 1
    })
});
...
map.getView().fit([-8209246.374133, 1190118.485041, -8031831.024172, 1316979.609193], map.getSize());
